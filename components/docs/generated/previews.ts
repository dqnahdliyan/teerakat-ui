...
export const previews: Record<string, any> = {
  ...
  "media/card-demo": {
    component: React.lazy(() => import("@/components/docs/media/card-demo")),
  },
  "media/card-login-form-demo": {
    component: React.lazy(() => import("@/components/docs/media/card-login-form-demo")),
  },
  "media/avatar-demo": {
  ...
  "media/card-table-demo": {
    component: React.lazy(() => import("@/components/docs/media/card-table-demo")),
  },
  "media/icon-demo": {
    component: React.lazy(() => import("@/components/docs/media/icon-demo")),
  },
