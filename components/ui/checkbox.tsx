...
const CheckboxGroup = (props: CheckboxGroupProps) => {
    return (
        <Primitive.CheckboxGroup {...props} className={cn('flex flex-col gap-2', props.className)}>
...
const Checkbox = (props: Primitive.CheckboxProps) => {
    return (
        <Primitive.Checkbox
            {...props}
            className={cn('group flex items-center gap-2 text-sm transition disabled:opacity-70', props.className)}
        >
