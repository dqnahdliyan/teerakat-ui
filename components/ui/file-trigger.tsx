...
interface FileTriggerProps extends Primitive.FileTriggerProps, VariantProps<typeof buttonVariants> {
    withIcon?: boolean
    isDisabled?: boolean
}

const FileTrigger: React.FC<FileTriggerProps> = ({ variant = 'primary', withIcon = true, ...props }) => {
    return (
        <>
