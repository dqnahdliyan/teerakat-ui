...
const Table = ({ children, className, ...props }: Primitive.TableProps & { className?: string }) => (
...
const TableCell = ({ children, className, ...props }: Primitive.CellProps & { className?: string }) => (
    <Primitive.Cell {...props} className={cell({ className })}>
        {children}
    </Primitive.Cell>
)

const TableColumn = ({ children, className, ...props }: Primitive.ColumnProps & { className?: string }) => (
...
const TableHeader = <T extends object>({
    ...
    let { selectionBehavior, selectionMode, allowsDragging } = Primitive.useTableOptions()
    return (
