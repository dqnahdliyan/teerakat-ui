...
const buttonVariants = tv({
    ...
    variants: {
        variant: {
            primary: 'bg-primary text-primary-foreground pressed:ring pressed:ring-primary/40 shadow-sm',
            secondary: 'bg-secondary text-secondary-foreground pressed:ring pressed:ring-secondary/40 shadow-sm',
            danger: 'bg-danger text-danger-foreground pressed:ring pressed:ring-danger/40 shadow-sm',
            success: 'bg-success text-success-foreground pressed:ring pressed:ring-success/40 shadow-sm',
            info: 'bg-info text-info-foreground pressed:ring pressed:ring-info/40 shadow-sm',
            warning: 'bg-warning text-warning-foreground pressed:ring pressed:ring-warning/40 shadow-sm',
