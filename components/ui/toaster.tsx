        ...
        <Sonner
            ...
            toastOptions={{
                ...
                classNames: {
                    ...
                    actionButton: 'py-1 rounded-md text-xs px-2 bg-primary text-primary-foreground',
                    cancelButton: 'py-1 rounded-md text-xs px-2 bg-secondary text-secondary-foreground'
                }
            }}
            icons={{
