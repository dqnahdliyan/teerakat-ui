...
import { AdobeLogo, DLogo, FramerLogo, Logo, LucideLogo, ShadcnLogo, TailwindLogo } from '@/components/logo'
...
import { Collection, LinkProps } from 'react-aria-components'
import { Button, Icon, Keyboard, Link, Menu, Separator, Sheet } from 'ui'
...
export function NavbarDropdown() {
    ...
    return (
        <Menu>
            <Button aria-label='Menu' variant='ghost' className='group -ml-1 [&_svg]:size-5'>
                <span className='flex items-center gap-x-2'>
                    <Logo className='-ml-1 size-6' />
                    <span className='font-mono text-base tracking-tight sm:text-sm'>Teerakat-UI</span>
                    <Icon
                        icon='ChevronDown'
                        className='-mr-2 ml-1 size-4 text-muted-foreground transition duration-300 group-hover:text-foreground group-pressed:rotate-180 group-pressed:text-foreground'
                    />
