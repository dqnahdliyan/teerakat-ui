...
type CarouselComponent = React.ForwardRefExoticComponent<React.HTMLAttributes<HTMLDivElement>> &
...
const CarouselPrevious = ({ className, variant = 'outline', size = 'icon', ...props }: ButtonProps) => {
