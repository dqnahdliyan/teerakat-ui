...
const Label = (props: Primitive.LabelProps) => {
    return (
        <Primitive.Label
            {...props}
            className={cn('w-fit cursor-default text-sm font-medium text-secondary-foreground', props.className)}
        />
    )
}
...
const FieldError = (props: Primitive.FieldErrorProps) => {
    return <Primitive.FieldError {...props} className={cn('text-sm text-danger', props.className)} />
}
...
export { Description, fieldBorderStyles, FieldError, FieldGroup, fieldGroupStyles, Input, Label }
