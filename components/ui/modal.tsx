...
const ModalOverlay = ({ className, isDismissable = true, ...props }: Primitive.ModalOverlayProps) => (
    <ModalOverlayContext.Provider value={{ isDismissable: isDismissable }}>
        <Primitive.ModalOverlay
            isDismissable={isDismissable}
            className={(values) =>
                cn(
                    'fixed inset-0 z-50 bg-black/60 backdrop-blur-sm entering:animate-in entering:fade-in-0 exiting:animate-out exiting:fade-out-0',
