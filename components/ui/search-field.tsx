...
function SearchField({ placeholder = 'Search', label, description, errorMessage, ...props }: SearchFieldProps) {
    return (
        <Primitive.SearchField {...props} className={cn('group flex min-w-[40px] flex-col gap-1', props.className)}>
